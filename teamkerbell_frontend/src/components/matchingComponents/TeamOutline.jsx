...
const TeamOutline = ({title, profileimg, writer, uploaddate,category,meetingway,recruitnum,startdate,recruitjobs,languages,location}) => {
        ...
        <div className={styles.teamoutlinecontainer}>
            ...
            <div className={styles.description}>
                ...
                <div className={styles.languages}>
                    사용 언어: {languages.map(language=><div key={language}>{language}</div>)}
                </div>
                <div className={styles.recruitjobs}>
                    모집 분야: {recruitjobs.map(job=><div key={job}>{job}</div>)}
                </div>
