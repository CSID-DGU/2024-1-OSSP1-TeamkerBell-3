...
import EndLeader from "../components/teamComponents/EndKick";
import EndMember from "../components/teamComponents/EndRun";
...
const Evaluation = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      {categoryStateValue === 0 && (isLeader(tid) ? <EndLeader /> : <EndMember />)}
